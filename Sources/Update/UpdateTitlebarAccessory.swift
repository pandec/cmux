...
extension AppDelegate {
    ...
    func performMinimalModeSidebarControlAction(
        ...
        switch slot {
        case .toggleSidebar:
            _ = toggleSidebarInActiveMainWindow(preferredWindow: window)
        case .showNotifications:
        ...
        case .newTab:
            let targetTabManager = activeTabManagerForCommands(preferredWindow: window)
        ...
        case .focusHistoryBack:
            ...
            activeTabManagerForCommands(preferredWindow: window)?.navigateBack()
        case .focusHistoryForward:
            guard focusHistoryNavigationAvailability(preferredWindow: window).canNavigateForward else { return }
            activeTabManagerForCommands(preferredWindow: window)?.navigateForward()
        case .compactMenu:
