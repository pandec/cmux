  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "markOldestUnreadAndJumpNext", combos: [["⌃", "⌘", "U"]], description: { en: "Mark current item as oldest unread and jump to the next latest unread", ja: "現在の項目を最古の未読にして次の最新未読へ移動" } },
      {
        ...
        combos: [],
        description: {
          ar: "تعليم كل الإشعارات كمقروءة",
          bs: "Označi sva obavještenja kao pročitana",
          da: "Marker alle notifikationer som læste",
          de: "Alle Benachrichtigungen als gelesen markieren",
          en: "Mark all notifications read",
          es: "Marcar todas las notificaciones como leídas",
          fr: "Marquer toutes les notifications comme lues",
          it: "Segna tutte le notifiche come lette",
          ja: "すべての通知を既読にする",
          km: "សម្គាល់ការជូនដំណឹងទាំងអស់ថាបានអាន",
          ko: "모든 알림을 읽음으로 표시",
          no: "Merk alle varsler som lest",
          pl: "Oznacz wszystkie powiadomienia jako przeczytane",
          "pt-BR": "Marcar Todas as Notificações como Lidas",
          ru: "Отметить все уведомления как прочитанные",
          th: "ทำเครื่องหมายการแจ้งเตือนทั้งหมดว่าอ่านแล้ว",
          tr: "Tüm Bildirimleri Okundu İşaretle",
          uk: "Позначити всі сповіщення як прочитані",
          "zh-CN": "将所有通知标记为已读",
          "zh-TW": "將所有通知標示為已讀",
        },
        note: {
          ar: "غير مُعيّن افتراضيًا",
          bs: "nije dodijeljeno prema zadanim postavkama",
          da: "ikke tildelt som standard",
          de: "standardmäßig nicht gebunden",
          ...
          uk: "не призначено за замовчуванням",
          "zh-CN": "默认未绑定",
          "zh-TW": "預設未綁定",
        },
      },
      {
        ...
        description: {
          ar: "مسح كل الإشعارات",
          bs: "Obriši sva obavještenja",
          da: "Ryd alle notifikationer",
          ...
          ja: "すべての通知をクリア",
          km: "សម្អាតការជូនដំណឹងទាំងអស់",
          ko: "모든 알림 지우기",
          no: "Fjern alle varsler",
          pl: "Wyczyść wszystkie powiadomienia",
          "pt-BR": "Limpar Todas as Notificações",
          ru: "Очистить все уведомления",
          th: "ล้างการแจ้งเตือนทั้งหมด",
          tr: "Tüm Bildirimleri Temizle",
          uk: "Очистити всі сповіщення",
          "zh-CN": "清除所有通知",
          "zh-TW": "清除所有通知",
        },
        note: {
