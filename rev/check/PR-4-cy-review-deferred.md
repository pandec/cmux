# PR #4 cy-review deferred findings

- `ADV-1` — rejected after verification: replacing the sidebar-derived presentation snapshot with hit-region registry geometry would broaden the titlebar interaction architecture without a demonstrated mismatch.
